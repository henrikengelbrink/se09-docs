...
Furthemore, the Ambassador Edge Stack is also terminating TLS. Therefore it is using the cert-manager and Let's Encrypt to automatically provision and update TLS certificates for all domains. Through TLS the entire communication via HTTPS between the clients and the server is encrypted.
